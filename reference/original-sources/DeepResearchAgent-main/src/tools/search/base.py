...
class SearchItem(BaseModel):
    ...
    position: int | None = Field(default=None, description="The position of the search result in the list")
    source: str | None = Field(default=None, description="The source of the search result")
